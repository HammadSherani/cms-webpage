...
<head>
    ...
    <title>L.P.H - Order Complete</title>
...
<section class="thank-you-section">
    <div class="container">
        <div class="thank-you-card">
            ...
            <p>We truly appreciate your business and we are working on processing your order.</p>
            <!-- Button to go back to homepage -->
            <div class="thank-you-button">
                <a href="{{url("/$marketerId")}}" class="btn btn-primary">Back to Homepage</a>
            </div>
        </div>
    </div>
</section>
